...
| [wysiwyg.md](2026-09-21_wysiwyg/wysiwyg.md) | 所见即所得编辑模式（Live Preview，Obsidian 式）：需求已确认——形态/预览分栏联动/特性范围/切换记忆四项拍板（D1–D4） | 🔶 **需求已确认**（分支 `feature/wysiwyg-editor`） |
| [wysiwyg_design.md](2026-09-21_wysiwyg/wysiwyg_design.md) | 所见即所得技术设计：自研 CM6 ViewPlugin 遍历 Lezer 语法树的装饰方案，节点映射表 / 复用边界 / IME 冻结 / 分栏联动 / 三批次实施 | 🔶 **设计完成，待实施**（D1–D6） |
