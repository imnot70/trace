...
| 2 | **心流引用与速览增强 P1：Esc 分级修正**（关预览保留补全面板；用户确认现状可接受，降级为普通待办，约半小时） | 第四节「待增补」 |
| 3 | **心流引用与速览增强 P2**：`[[` 补全扁平模糊匹配 + 搜索结果键盘导航与 Alt+Enter 预览（约 1~2 天，立项时补 FR 编号） | 第四节「待增补」 |
| 4 | **心流引用与速览增强 P3（可选）**：三源拖曳生成引用（建议 P2 试用后再定） | 第四节「待增补」 |
