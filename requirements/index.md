...
- **`fix/hardening-batch`**（当前分支）：加固批次——技术债评审的 4 项缺陷与 3 项地基加固已全部修复，**待验证后合并发版**；
- 无规划中的新功能。
...
| # | 事项 | 位置 / 说明 |
| --- | --- | --- |
| 1 | **真机验证 `fix/hardening-batch`**（加固批次）：重点过一遍冲突解决、git 同步、搜索（新建笔记后可搜到）、常用列表 | CHANGELOG 未发布段 |
| 2 | **合并 `fix/hardening-batch` → main → 发 v0.8.5** | `npm version patch` |
